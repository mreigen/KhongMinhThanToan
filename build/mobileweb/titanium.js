...
var require = {
	app: {
		analytics: true,
		copyright: "2013 by mreigen",
		deployType: "development",
		description: "not specified",
		guid: "83fc2739-99ed-4d78-abb8-f7b7b9cd8fa8",
		id: "KhongMinhThanToan",
		name: "KhongMinhThanToan",
		names: {},
		publisher: "mreigen",
		url: "http://",
		version: "1.0"
...
p.setString("acs-api-key-production","eveduLFLQ5H9cgw1UvSHxPkZgQfV6bnq");
p.setString("acs-api-key-development","mZOlbTERO5N4cOa4ABJNE1OoEe0VX5Vc");
p.setString("acs-oauth-secret-development","Nnf1PUWB4D6hexRf5ZJf5sfHXuuYf7E1");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","CPoNZudse1wl6lgtn2eX7VuzL62OvfaM");
p.setString("acs-oauth-key-development","8A2bvLbkyB7KP3GPHihfNS69RMHkTlfi");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","F8KvIcfWuenthpzFTWiZfuyMD3g6YvVk");
});
