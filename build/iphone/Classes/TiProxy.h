...
//Rare exceptions to indicate a bug in the _khongminhthantoan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for KhongMinhThanToan proxies.
 */
