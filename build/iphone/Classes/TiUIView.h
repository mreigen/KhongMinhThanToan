...
/**
 Base class for all KhongMinhThanToan views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the KhongMinhThanToan view hierarchy (such as wrapped iOS UIViews) was touched.
