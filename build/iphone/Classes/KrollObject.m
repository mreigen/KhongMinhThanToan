 ...
 * Copyright (c) 2009-2011 by KhongMinhThanToan, Inc. All Rights Reserved.
...
//@interface KhongMinhThanToanObject : NSObject
//@end

@interface KhongMinhThanToanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KhongMinhThanToanObject class]])
		{
			for (NSString *key in [[(KhongMinhThanToanObject*)o modules] allKeys])
			{
