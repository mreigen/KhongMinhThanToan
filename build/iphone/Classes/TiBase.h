...
// in simulator we redefine to format for KhongMinhThanToan Developer console
...
{\
	NSString * exceptionName = [@"org.khongminhthantoan." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.khongminhthantoan";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIKhongMinhThanToanNativeItemNone = -1, 
	UIKhongMinhThanToanNativeItemSpinner = -2,
	UIKhongMinhThanToanNativeItemProgressBar = -3,
	
	UIKhongMinhThanToanNativeItemSlider = -4,
	UIKhongMinhThanToanNativeItemSwitch = -5,
	UIKhongMinhThanToanNativeItemMultiButton = -6,
	UIKhongMinhThanToanNativeItemSegmented = -7,
	
	UIKhongMinhThanToanNativeItemTextView = -8,
	UIKhongMinhThanToanNativeItemTextField = -9,
	UIKhongMinhThanToanNativeItemSearchBar = -10,
	
	UIKhongMinhThanToanNativeItemPicker = -11,
	UIKhongMinhThanToanNativeItemDatePicker = -12,
	
	UIKhongMinhThanToanNativeItemInfoLight = -13,
	UIKhongMinhThanToanNativeItemInfoDark = -14,
	
	UIKhongMinhThanToanNativeItemDisclosure = -15,
	
	UIKhongMinhThanToanNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KhongMinhThanToan instances of
