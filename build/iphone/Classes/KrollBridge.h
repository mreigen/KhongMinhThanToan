...
@interface KhongMinhThanToanObject : KrollCoverageObject {
#else
@interface KhongMinhThanToanObject : KrollObject {
#endif
@private
...
extern NSString * KhongMinhThanToan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KhongMinhThanToanObject *_khongminhthantoan;
    KrollObject* console;
	BOOL shutdown;
